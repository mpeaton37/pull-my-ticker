...
## Agent Protocol
- Contact: Michael Eaton (@mpeaton, mpeaton@gmail.com).
- Workspace: `~/Projects`. Missing mpeaton repo: clone `https://github.com/mpeaton37/mpeaton.git`.
- 3rd-party/OSS (non-mpeaton): clone under `~/Projects/oss`.
...
- Oracle: run `npx -y @mpeaton/oracle --help` once/session before first use.
...
## Important Locations
- Blog repo: `~/Projects/mpeaton.me`
- Notes/Runbooks: `~/Projects/manager/docs/` (e.g. `mac-studio.md`, `mac-vm.md`)
- OpenAI/Codex limits tracking: `~/Documents/mpeaton/codex limits.md`
- Obsidian vault: `$HOME/Library/Mobile Documents/iCloud~md~obsidian/Documents/mpeaton-notes`
...
- Run `npx -y @mpeaton/oracle --help` once/session (before first use).
